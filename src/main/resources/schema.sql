...
create table if not exists users (id bigint not null auto_increment, email varchar(50), first_name varchar(100), last_name varchar(100), age tinyint, password varchar(100), primary key (id)) engine=InnoDB;
